  ...
  return {
    stocks: [
      ...
      },
      {
        ...
        priceHistory: timestamps.map((ts, idx) => ({
          timestamp: ts,
          price: 252.0 + Math.random() * 15 - Math.cos(idx / 4) * 8,
      ...
      },
      {
        ...
        priceHistory: timestamps.map((ts, idx) => ({
          timestamp: ts,
          price: 469.0 + Math.random() * 20 + Math.sin(idx / 3) * 10,
    ...
    cryptocurrencies: [
      {
        ...
        alerts: [
          ...
          },
          {
            ...
            severity: "high",
            message:
              "Large wallet accumulation: 5,000+ BTC moved to cold storage",
            timestamp: new Date(Date.now() - 3600000).toISOString(),
            impact: "positive",
          },
          {
    ...
    news: [
      {
        id: "news_1",
        title:
          "Federal Reserve Holds Interest Rates Steady, Signals Potential Cuts",
        ...
        summary:
          "The Federal Reserve announced it will maintain current interest rates while hinting at potential cuts in the coming quarters. This decision has significant implications for both traditional equities and cryptocurrencies.",
        sentiment: 0.65,
      ...
      },
      {
        ...
        summary:
          "NVIDIA unveiled its next-generation AI chips with 3x performance improvements, triggering significant market movement in tech stocks.",
        sentiment: 0.88,
      ...
      },
      {
        ...
        affectedAssets: ["BTC"],
        summary:
          "Institutional investors continue to pour money into Bitcoin ETFs, with net inflows reaching $2.5 billion this week alone.",
        sentiment: 0.82,
      ...
      },
      {
        ...
        summary:
          "Cryptocurrency exchange detected and prevented suspicious trading patterns, maintaining market integrity.",
        sentiment: 0.45,
      ...
      },
      {
        ...
        affectedAssets: ["TSLA"],
        summary:
          "Tesla delivered 485,000 vehicles in Q4, surpassing analyst estimates and demonstrating strong demand.",
        sentiment: 0.79,
      ...
      },
      {
        ...
        affectedAssets: ["AAPL"],
        summary:
          "European regulators launch new antitrust probe into Apple's App Store practices and payment systems.",
        sentiment: 0.42,
      ...
      },
      {
        ...
        affectedAssets: ["ETH"],
        summary:
          "Ethereum Layer 2 networks processed over $50 billion in transactions this month, demonstrating scaling success.",
        sentiment: 0.77,
      ...
      },
      {
        ...
        affectedAssets: ["MSFT"],
        summary:
          "Microsoft's cloud division continues to drive growth with Azure revenue reaching $31.8 billion.",
        sentiment: 0.73,
    ...
    alerts: [
      ...
      },
      {
        ...
        message:
          "Traditional correlation between stocks and crypto has weakened significantly",
        timestamp: new Date(Date.now() - 7200000).toISOString(),
      ...
      },
      {
        ...
        message:
          "Trading volume below 30-day average by 40% - potential for increased volatility",
        timestamp: new Date(Date.now() - 10800000).toISOString(),
        affectedAssets: ["SOL"],
        actionRequired: true,
        aiCoreAccuracy: 0.96,
    ...
    aiCoreInsights: [
      {
        ...
        description:
          "AI Core has identified a classic bullish flag pattern with 94% historical accuracy. Target: $45,500",
        timestamp: new Date(Date.now() - 5400000).toISOString(),
        actionable: true,
      },
      {
        ...
        description:
          "Significant call option buying detected suggesting institutional bullish sentiment",
        timestamp: new Date(Date.now() - 7200000).toISOString(),
        actionable: true,
      },
      {
        ...
        description:
          "Overall market sentiment shifted from neutral to bullish over past 24 hours",
        timestamp: new Date(Date.now() - 3600000).toISOString(),
        actionable: false,
      },
    ],
