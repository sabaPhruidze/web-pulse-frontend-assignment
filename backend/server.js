...
app.listen(PORT, () => {
  ...
  console.log(
    `   - Assets: GET /api/assets, /api/assets/stocks, /api/assets/crypto`,
  );
  console.log(
    `   - News: GET /api/news, /api/news/asset/:symbol, /api/news/category/:category`,
  );
  console.log(
    `   - Alerts: GET /api/alerts, /api/alerts/critical, /api/alerts/severity/:severity`,
  );
